...
const LoginScreen = () => {
    ...
    const horizontal = () => {
        ...
        for (let index = 0; index < horizontal; index++) {
            elements.push(<div key={index} className={`boxColor`} style={{ height: '50px', width: '50px', backgroundColor: '#FFF6E9', marginRight: '4px', display: 'inline-block' }}></div>)
        }
        return elements;
    ...
    function resetBoxColor(element) {
        element.style.backgroundColor = "#FFF6E9";
    }
    ...
    useEffect(() => {
        ...
        boxes.forEach((box) => {
            box.addEventListener("mouseover", () => {
                box.style.backgroundColor = "#D5F0C1"; // Change color on hover
            });
        ...
        <div className={style.fullScreen}>
            ...
            <div className={style.loginContainer}>
                <div className={style.loginContent}>
                    <h1 className={style.welcomeText}>Sign In</h1>
